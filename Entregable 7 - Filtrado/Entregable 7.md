...
### 1. Introducción 
  ...
  Los filtros pueden ser divididos en dos grandes grupos: filtros analógicos y filtros digitales
   ...
   #### Filtros analógicos
    Un filtro analógico es usado para señales en tiempo continuo, se pueden clasificar en filtros pasivos o activos de acuerdo al tipo de elementos que se utilizan         [1]. Hay cuatro tipos básicos de filtros: 
      ...
      - Filtro rechaza-bandas: atenúa las frecuencias comprendidas entre la frecuencia de corte inferior y la frecuencia de corte superior, dejando pasar las demás [2]
