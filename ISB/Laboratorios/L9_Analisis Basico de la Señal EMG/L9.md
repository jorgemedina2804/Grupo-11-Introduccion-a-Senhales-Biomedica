...
<p align="justify">
En la primera figura se puede observar a la señal de EMG original, mientras que a la derecha se observa la señal luego de haberle aplicado  Teager-Kaiser energy operator (TKEO). TKEO es una técnica que fue propuesta para mejorar las relaciones señal-ruido y minimizar la detección errónea de inicio de EMG. Una de las ventajas de la técnica de TKEO es que la energía calculada se deriva de la amplitud instantánea y la frecuencia instantánea de la señal, con lo cual la técnica puede mejorar nuestra capacidad para analizar la actividad muscular, ya que la despolarización de la membrana de la célula muscular durante la contracción produce fluctuaciones rápidas en la amplitud y frecuencia de la señal [1]. 
...
[Notebook Análisis EMG](https://github.com/jorgemedina2804/Grupo-11-Introduccion-a-Senhales-Biomedica/blob/main/ISB/Laboratorios/L9_Analisis%20Basico%20de%20la%20Se%C3%B1al%20EMG/Archivos%20en%20Python/LABORATORIO9_EMG.ipynb)
 ...
 ### Referencias
[1]. S. Solnik, P. Rider, K. Steinweg, P. DeVita, and T. Hortobágyi, “Teager–kaiser energy operator signal conditioning improves EMG onset detection,” European Journal of Applied Physiology, vol. 110, no. 3, pp. 489–498, 2010. doi:10.1007/s00421-010-1521-8 
